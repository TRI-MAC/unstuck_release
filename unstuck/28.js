...
/***/ "./src/libs_frontend/toast_utils.js":
/*!******************************************!*\
  !*** ./src/libs_frontend/toast_utils.js ***!
  \******************************************/
/*! no static exports found */
...
__webpack_require__(/*! bower_components/habitlab-paper-toast/habitlab-paper-toast.deps */ "./src/bower_components/habitlab-paper-toast/habitlab-paper-toast.deps.js")
...
function show_toast(options) {
  ...
  let $toast = $('<habitlab-paper-toast>')
  $toast.css({
    'z-index': 2147483646,
    'margin': '12px',
    'padding': '16px 24px',
  ...
  if (options.close_button) {
    ...
    $toast.append('<br>')
    //$toast.append($('<habitlab-paper-button text="Close">'))
  }
