...
/***/ "./src/components/habitlab-habitlab-intervention-feedback.deps.js":
/*!***************************************************************!*\
  !*** ./src/components/habitlab-habitlab-intervention-feedback.deps.js ***!
  \***************************************************************/
/*! no static exports found */
...
import_dom_modules(__webpack_require__(/*! components/habitlab-habitlab-intervention-feedback.html */ "./src/components/habitlab-habitlab-intervention-feedback.html"), 'components/habitlab-habitlab-intervention-feedback.html')
__webpack_require__(/*! components/habitlab-habitlab-intervention-feedback */ "./src/components/habitlab-habitlab-intervention-feedback.js")


/***/ }),

/***/ "./src/components/habitlab-habitlab-intervention-feedback.html":
/*!************************************************************!*\
  !*** ./src/components/habitlab-habitlab-intervention-feedback.html ***!
  \************************************************************/
/*! no static exports found */
...
module.exports = "<link rel=import href=../bower_components/polymer/polymer.html> <link rel=import href=../bower_components/polymer-themes/ice.html> <link rel=import href=../bower_components/habitlab-paper-toast/habitlab-paper-toast.html> <link rel=import href=../bower_components/habitlab-paper-button/habitlab-paper-button.html> <habitlab-dom-module id=habitlab-habitlab-intervention-feedback> <template> <style>:host{z-index:9007199254740991}#intervention_name_display{margin-top:10px}.intervention-icon{align:center;height:50px;width:50px;margin-right:10px;border-radius:5px;box-shadow:2px 2px 2px #888}#sample_toast{width:350px;height:300px;z-index:9007199254740991;background-color:#f0f8ff;color:#000}.yellow-button{height:38px;width:100%;text-transform:none;background-color:#415d67;color:#fff;margin:0 auto;box-shadow:2px 2px 2px #888;margin-bottom:10px}</style> <habitlab-paper-toast id=sample_toast text=\"\" duration=0 vertical-align=top horizontal-align=right> <div>How <strong>intense</strong> was this nudge you just saw?</div> <div style=margin-top:10px;background-color:#383838;border-radius:5px;padding:5px;color:#fff> <div style=display:flex;align-items:center;align-content:center;justify-content:center> <img class=intervention-icon src={{intervention_icon}} /> <h2 style=margin-right:25px;font-size:24px;color:#fff>{{intervention_name}}</h2> </div> <div style=display:flex;align-items:center;align-content:center;justify-content:center;padding-bottom:5px> <div style=text-align:center;font-size:11px;color:#fff>{{intervention_description}}</div> </div> </div> <div style=padding-top:10px></div> <div> <habitlab-paper-button id=too_intense_button class=yellow-button on-click=too_intense_clicked>Too intense</habitlab-paper-button> <habitlab-paper-button id=not_intense_button class=yellow-button on-click=not_intense_clicked>Not intense enough</habitlab-paper-button> <habitlab-paper-button id=just_right_button_button class=yellow-button on-click=just_right_clicked>Just right</habitlab-paper-button> </div> </habitlab-paper-toast> </template> <script src=habitlab-habitlab-intervention-feedback.js></script> </habitlab-dom-module>";

/***/ }),

/***/ "./src/components/habitlab-habitlab-intervention-feedback.js":
/*!**********************************************************!*\
  !*** ./src/components/habitlab-habitlab-intervention-feedback.js ***!
  \**********************************************************/
/*! no static exports found */
...
Polymer({
  is: 'habitlab-habitlab-intervention-feedback',
  properties: {
  ...
  show: function() {
    if (this.intervention_info == null) {
      this.intervention_info = __webpack_require__(/*! libs_common/intervention_info */ "./src/libs_common/intervention_info.ls").get_intervention();
    }
...
/***/ "./src/frontend_utils/close_tab_message.js":
/*!*************************************************!*\
  !*** ./src/frontend_utils/close_tab_message.js ***!
  \*************************************************/
/*! no static exports found */
...
function show_reward_display() {
  ...
  $('habitlab-habitlab-intervention-feedback').remove()
  let reward_display = $('<habitlab-habitlab-intervention-feedback>')
...
if (!window.close_tab_message_loaded) {
  ...
  __webpack_require__(/*! components/habitlab-habitlab-intervention-feedback.deps */ "./src/components/habitlab-habitlab-intervention-feedback.deps.js")
}
...
/***/ 1:
/*!*******************************************************!*\
  !*** multi ./src/frontend_utils/close_tab_message.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/marcomora/Documents/Github/unstuck_extension/src/frontend_utils/close_tab_message.js */"./src/frontend_utils/close_tab_message.js");
