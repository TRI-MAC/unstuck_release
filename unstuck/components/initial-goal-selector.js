(function(){
  ...
  polymer_ext({
    ...
    daily_goal_help_clicked: function(){
      return swal({
        title: 'How wil Unstuck help me achieve these goals?',
        text: 'Unstuck will help you achieve these goals by showing you a different nudge, like a news feed blocker or a delayed page loader, each time you visit your goal sites. (It will not block the site.)'
      });
    },
    openBy: function(evt){
