(function(){
  ...
  polymer_ext({
    ...
    ready: async function(){
      ...
      this.$$('#userid_label').innerHTML = userid;
      this.rerender();
      this.show_swal();
    ...
    survey_button_clicked: async function(){
      ...
      userid = (await get_user_id());
      chrome.tabs.create({
        url: survey_data.url + '?habitlab_userid=' + userid + '&click_location=settings'
      });
    ...
    onboarding_button_clicked: async function(){
